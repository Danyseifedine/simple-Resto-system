 ...
 *
 * This module handles all menu-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for menu operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => menuTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/menus/${path}`;
 ...
 * Defines the structure and behavior of the Menu management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
    ...
    },
    {
        ...
        "render": function (data) {
            return `<img src="${data}" alt="Image" class="img-fluid" style="width: 70px; height: 70px;">`;
        }
    },
    {
        "data": null,
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected menus
 * @param {Array} selectedIds - Array of selected menu IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple menus, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main menu management interface
 *============================================================================*/
export const menuTable = new $DatatableController('menuTable', {
