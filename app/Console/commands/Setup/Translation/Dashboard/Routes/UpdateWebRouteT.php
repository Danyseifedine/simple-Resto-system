...
namespace App\Console\Commands\Setup\Translation\Dashboard\Routes;

use Illuminate\Console\Command;

class UpdateWebRouteT extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lebify:dashboard-web-route-t';
