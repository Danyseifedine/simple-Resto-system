...
class NavbarT extends Command
{
     ...
     * @var string
     */
    protected $signature = 'lebify:dashboard-common-navbar-t';
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <span class="menu-title position-relative">{{ __('common.language') }}
                                    ...
                                    @elseif (LaravelLocalization::getCurrentLocale() == 'fr')
                                        <span
                                            ...
                                            <img class="w-15px h-15px rounded-1 ms-2"
                                                src="{{ asset('core/vendor/img/flags/france.svg') }}"
                                                alt="" /></span>
                                    @endif
                                </span>
                            </a>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('logout') }}" class="menu-link px-5">{{ __('actions.log_out') }}</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
