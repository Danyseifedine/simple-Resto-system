...
namespace App\Console\Commands\Setup\Translation\Dashboard\Controller;

use Illuminate\Console\Command;

class CreateControllersT extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lebify:dashboard-create-controllers-t';
