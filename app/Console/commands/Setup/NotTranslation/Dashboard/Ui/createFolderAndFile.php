...
namespace App\Console\Commands\Setup\NotTranslation\Dashboard\Ui;

use Illuminate\Console\Command;

class createFolderAndFile extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lebify:dashboard-create-folder-and-file';
